...
response_users = client.list_users(
    ...
    MaxResults=265  # Puedes ajustar este valor según la cantidad de usuarios
)
...
response_groups = client.list_groups(
    IdentityStoreId=identity_store_id,
    MaxResults=265  # Puedes ajustar este valor según la cantidad de grupos
)
...
for group in groups:
    ...
    response_memberships = client.list_group_memberships(
        IdentityStoreId=identity_store_id,
        GroupId=group_id,
        MaxResults=265  # Puedes ajustar este valor si un grupo tiene muchos miembros
    )
